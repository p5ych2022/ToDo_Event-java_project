...
public class Dateview extends JDialog{
    ...
    public Dateview(String date) throws IOException {
        ...
        switch (today.getData().getWeekDay()){
            case 1: lable1_1_content = "周一";break;
            case 2: lable1_1_content = "周二";break;
            case 3: lable1_1_content = "周三";break;
            case 4: lable1_1_content = "周四";break;
            case 5: lable1_1_content = "周五";break;
            case 6: lable1_1_content = "周六";break;
            case 7: lable1_1_content = "周天";break;
        ...
        addButton.addActionListener(e -> showAddEventView());  // 设置按钮点击事件
